...
namespace MN\Shared\Infrastructure\Bus\Event\MySql;

use DateTimeImmutable;
use Doctrine\DBAL\FetchMode;
use Doctrine\ORM\EntityManager;
use MN\Shared\Domain\Utils;
use MN\Shared\Infrastructure\Bus\Event\DomainEventClassNotExist;
use MN\Shared\Infrastructure\Bus\Event\DomainEventMapping;
...
final class MySqlDoctrineDomainEventsConsumer
{
    ...
    private function executeSubscribers(callable $subscribers): callable
    {
        return function (array $rawEvent) use ($subscribers): void {
            ...
            } catch (DomainEventClassNotExist $error) {
            }
        };
    }
